...
class ProfileImageSetup extends StatefulWidget {
  ...
  ProfileImageSetup({Key? key, required this.hintText, required this.userId, required this.providerId}) : super(key: key);
...
class _ProfileImageSetupState extends State<ProfileImageSetup> {
  ...
  Future<void> uploadImage(String userId, File imageFile, String providerId) async {
    try {
      final endpoint = providerId.isNotEmpty? api_endpoint_finish_signup_provider: api_endpoint_finish_signup_user;
